...
function [S,P] = Dotsflow_DirectionFFT()
% Settings for DotsflowDirectionFFT 
...
% PROTOCOL PREFIX
S.protocol = 'DotsflowDirectionFFT';
% PROTOCOL PREFIXS
...
P.trialdur = 12 .* 2.0*20; % this is also the stimulus duration 
