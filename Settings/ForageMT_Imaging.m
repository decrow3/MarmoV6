...
S.finish = 50; % 50 repeats 

% PROTOCOL PREFIX
S.protocol = 'ForageMT_Imaging';
% PROTOCOL PREFIXS
...
P.noiseDur = 0.6; % >0.5 & <1s
S.noiseDur = 'Time for noise ON';
P.cycleTime=[0,P.noiseDur:P.noiseDur:24];
S.cycleTime='ON-OFF cycle time points';
P.stimEnds = 2:2:2*20;
S.stimEnds = 'stimulus end times';

P.trialdur = P.noiseDur*2*20; % ON-OFF*ncycles = run/trial  
