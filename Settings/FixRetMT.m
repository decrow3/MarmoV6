...
S.protocolTitle = 'Retinotopic mapping';
...
% Bar Stimulus settings ,- wedges settings can be moved here?
P.Radius = 8.0;  
S.Radius = 'Bar window radius(degs):';
...
% Stimulus settings
P.fixPointRadius = .15; % in deg, but recommended > than 4 pixels
