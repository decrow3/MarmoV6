function [S,P] = Acuity_Continuous
...
P.targWinRadius = 2.5; %1.5;
S.targWinRadius = 'Target window radius (deg):';
...
P.speed = 20;
S.speed = 'Speed of random walk (deg/s):';
