...
switch P.noisetype
    ...
    case 14 % Hyperplaid
        ...
        % Tight grid controls
        P.hp_maxSF         = 4;        S.hp_maxSF         = 'Max spatial freq (cyc/deg):';
        ...
        P.noiseFrameRate   = 10;      S.noiseFrameRate  = 'Hz (200 ms static frames)';
        %P.noiseContrast    = 0.4;     S.noiseContrast   = 'overall RMS target (scaled per component)';
