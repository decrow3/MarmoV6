...
function [S,P] = Simpler_DriftingGratings()
...
switch P.noisetype
    ...
    case 6 % drifting gratings
        ...
        P.GratSFmin = 0.125;  % will be [0.5 1 2 4 8]
        S.GratSFmin = 'Minimum spat freq (cyc/deg):';
        
        P.GratNumOct = 6;   % use log spacing,0.125.*2.^(0:6)=[ 0.1250    0.2500    0.5000    1.0000    2.0000    4.0000    8.0000]
