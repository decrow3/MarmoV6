%% protocol for Dotsflow_Imaging 

classdef PR_DotsflowImaging < handle
  ...
  properties (Access = public), 
       ...
       FrameCount double = 0;
       MaxFrame double = 12.*240; % sec .* frame-rate 
       FlowHistory double = [];
  ...
  methods (Access = public)
      function o = PR_DotsflowImaging(winPtr)
      o.winPtr = winPtr; 
      o.trialsList = [];
    end
...
%        o.trialIndexer = marmoview.TrialIndexer(o.trialsList,P);
         ...
         o.hFlow = stimuli.dotspatialImaging(o.winPtr);   % dots flow stimulus
         o.FlowHistory = zeros(o.MaxFrame,5,300); % 300 dots 
    ...
    function drop = state_and_screen_update(o,currentTime,x,y,varargin) 
        ...
        if o.state == 0 && currentTime < o.startTime + o.P.trialdur
            ...
            o.hFlow.beforeFrame();
            o.hFlow.afterFrame(xshift, yshift,o.FrameCount);
