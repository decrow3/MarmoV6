%% protocol for Dotsflow_dir 
% Last Modification: Apr 07, 2025 - PSC 

classdef PR_DotsflowDirectionFFT < handle
  ...
  methods (Access = public)
      function o = PR_DotsflowDirectionFFT(winPtr)
      o.winPtr = winPtr; 
      o.trialsList = [];
    end
...
%        o.trialIndexer = marmoview.TrialIndexer(o.trialsList,P);
    ...
    function drop = state_and_screen_update(o,currentTime,x,y,varargin) 
        ...
        if o.state == 0 && currentTime < o.startTime + o.P.trialdur
            ...
            o.hFlow.beforeFrame();
            dirStimDur = 2;
            repDur = dirStimDur*12;
            rep = ceil((currentTime - o.startTime)./repDur);
            fc = 0;
            ...
            if o.FrameCount==0
                ...
                o.d = ceil(o.FrameCount./(240*dirStimDur));
            end 
            %d=12-floor((o.startTime + o.P.trialdur - currentTime)./1.5);
            
            o.modd = 0;%mod((o.FrameCount),(240*1.5));
            %curTrialTime = currentTime - o.startTime;
            repTime = (rep-1)*24;

            %currentTime - o.startTime-repTime
            if  (currentTime - o.startTime-repTime) > dirStimDur*0 && (currentTime - o.startTime-repTime) <= dirStimDur*1
                o.d = 1;
            elseif (currentTime - o.startTime-repTime) > dirStimDur*1 && (currentTime - o.startTime-repTime) <= dirStimDur*2
                o.d = 2;
            elseif (currentTime - o.startTime-repTime) > dirStimDur*2 && (currentTime - o.startTime-repTime) <= dirStimDur*3
                o.d = 3;
            elseif (currentTime - o.startTime-repTime) > dirStimDur*3 && (currentTime - o.startTime-repTime) <= dirStimDur*4
                o.d = 4;
            elseif (currentTime - o.startTime-repTime) > dirStimDur*4 && (currentTime - o.startTime-repTime) <= dirStimDur*5
                o.d = 5;
            elseif (currentTime - o.startTime-repTime) > dirStimDur*5 && (currentTime - o.startTime-repTime) <= dirStimDur*6
                o.d = 6;
            elseif (currentTime - o.startTime-repTime) > dirStimDur*6 && (currentTime - o.startTime-repTime) <= dirStimDur*7
                o.d = 7;
            elseif (currentTime - o.startTime-repTime) > dirStimDur*7 && (currentTime - o.startTime-repTime) <= dirStimDur*8
                o.d = 8;
            elseif (currentTime - o.startTime-repTime) > dirStimDur*8 && (currentTime - o.startTime-repTime) <= dirStimDur*9
                o.d = 9;
            elseif (currentTime - o.startTime-repTime) > dirStimDur*9 && (currentTime - o.startTime-repTime) <= dirStimDur*10
                o.d = 10;
            elseif (currentTime - o.startTime-repTime) > dirStimDur*10 && (currentTime - o.startTime-repTime) <= dirStimDur*11
                o.d = 11;
            elseif (currentTime - o.startTime-repTime) > dirStimDur*11 && (currentTime - o.startTime-repTime) <= dirStimDur*12
                o.d = 12;
            end
        ...
        yshift = hdy * (o.hFlow.speed * 1./(o.hFlow.refreshRate) * o.hFlow.pixPerDeg);
            ...
            o.FlowHistory(o.FrameCount,10,:) = rep;
...
%         %DPR - 5/5/2023
    ...
    function Iti = end_run_trial(o)
        Iti = 10; % returns generic Iti interval
    end
