...
classdef PR_DotsflowDirection < handle
  ...
  methods (Access = public)
      function o = PR_DotsflowDirection(winPtr)
      o.winPtr = winPtr; 
      o.trialsList = [];
    end
...
%        o.trialIndexer = marmoview.TrialIndexer(o.trialsList,P);
         ...
         o.FlowHistory = zeros(o.MaxFrame,9,P.numDots);
    ...
    function drop = state_and_screen_update(o,currentTime,x,y,varargin) 
        ...
        if o.state == 0 && currentTime < o.startTime + o.P.trialdur
            ...
            if  currentTime > o.startTime && currentTime <= o.startTime + 1.5*1
                o.d = 1;
