%% protocol for Dotsflow_SpdCardRand  
% Last Modification: Apr 16, 2025 - PSC 
% Notes: no ISI, 4 cardinal directions x 6 spds 

classdef PR_DotsflowSpdCardRand < handle
  ...
  methods (Access = public)
      function o = PR_DotsflowSpdCardRand(winPtr)
          o.winPtr = winPtr;
          o.trialsList = [];
      end
      ...
      function generate_trialsList(o,S,P)
           ...
           for k = 1:S.finish
                o.trialsList(k,1:24) = randperm(24);
           end 
    ...
    function initFunc(o,S,P)
       ...
       o.error = 0;
         ...
         o.hFlow = stimuli.dotspatial_spd(o.winPtr);   % dots flow stimulus
         o.FlowHistory = zeros(o.MaxFrame,12,P.numDots);
    ...
    function P = next_trial(o,S,P)
          ...
          % Make dots flow stimulus texture (?)
            ...
            o.hFlow.nspds = P.nspds;
            o.hFlow.direction = P.direction;
            o.hFlow.ndirs = P.ndirs;
            o.hFlow.spdmesh = P.spdmesh;
            o.hFlow.dirmesh = P.dirmesh;
    ...
    function drop = state_and_screen_update(o,currentTime,x,y,varargin)
        ...
        if o.state == 0 && currentTime < o.startTime + o.P.trialdur
            ...
            o.modd = 0;
            stimTime = 2;
            if currentTime <o.startTime
                o.d = 0;
            elseif currentTime>=o.startTime 
                o.d = ceil((currentTime-o.startTime)./stimTime); %use o.d to index into the trialsList 
            % elseif currentTime > o.startTime && currentTime <= o.startTime+ 1.5*1
            %     o.d = 1;
            % elseif currentTime > o.startTime+ 1.5*1 && currentTime <= o.startTime+ 1.5*2
            %     o.d = 2;
            % elseif currentTime > o.startTime+ 1.5*2 && currentTime <= o.startTime+ 1.5*3
            %     o.d = 3;
            % elseif currentTime > o.startTime+ 1.5*3 && currentTime <= o.startTime+ 1.5*4
            %     o.d = 4;
            % elseif currentTime > o.startTime+ 1.5*4 && currentTime <= o.startTime+ 1.5*5
            %     o.d = 5;
            % elseif currentTime > o.startTime+ 1.5*5 && currentTime <= o.startTime+ 1.5*6
            %     o.d = 6;
            % elseif currentTime > o.startTime+ 1.5*6 && currentTime <= o.startTime+ 1.5*7
            %     o.d = 7;
            % elseif currentTime > o.startTime+ 1.5*7 && currentTime <= o.startTime+ 1.5*8
            %     o.d = 8;
            % elseif currentTime > o.startTime+ 1.5*8 && currentTime <= o.startTime+ 1.5*9
            %     o.d = 9;
            % elseif currentTime > o.startTime+ 1.5*9 && currentTime <= o.startTime+ 1.5*10
            %     o.d = 10;
            % elseif currentTime > o.startTime+ 1.5*10 && currentTime <= o.startTime+ 1.5*11
            %     o.d = 11;
            % elseif currentTime > o.startTime + 1.5*11 && currentTime <= o.startTime+ 1.5*12
            %     o.d = 12;
            end
            ...
            if currentTime  <=(o.d*stimTime)+o.startTime 
                if o.d<=24 && o.d~=0
                    move = 1;
                    flowDir = o.P.dirmesh(o.P.condSeq(o.d));
                    flowSpd = o.P.spdmesh(o.P.condSeq(o.d));
                    ...
                    xshift = hdx * (flowSpd * 1./(o.hFlow.refreshRate) * o.hFlow.pixPerDeg);
                    % -o.P.speed * 1./(o.P.refreshRate) * obj.pixPerDeg
                    yshift = hdy * (flowSpd * 1./(o.hFlow.refreshRate) * o.hFlow.pixPerDeg);
                elseif o.d>24
                    xshift =0;
                    yshift =0;
                    move =2;
            ...
            o.FlowHistory(o.FrameCount,10,:) = flowSpd;
            o.FlowHistory(o.FrameCount,11,:) = move;
            if o.d >0 && o.d<=24
                o.FlowHistory(o.FrameCount,12,:) = o.P.condSeq(o.d);
            else
                o.FlowHistory(o.FrameCount,12,:) = nan;
            end 
    ...
    function PR = end_plots(o,P,A)   %update D struct if passing back info
        ...
        PR.dirmesh = o.P.dirmesh;
        PR.spdmesh = o.P.spdmesh;
