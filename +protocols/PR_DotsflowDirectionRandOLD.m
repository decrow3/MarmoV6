...
classdef PR_DotsflowDirectionRandOLD < handle
  ...
  methods (Access = public)
      function o = PR_DotsflowDirectionRandOLD(winPtr)
          o.winPtr = winPtr;
          o.trialsList = [];
      end
    ...
    function drop = state_and_screen_update(o,currentTime,x,y,varargin)
        ...
        if o.state == 0 && currentTime < o.startTime + o.P.trialdur
            ...
            %d=12-floor((o.startTime + o.P.trialdur - currentTime)./2.0);
            o.modd = mod((o.FrameCount),(240*2.0));


            if currentTime  <=(o.d*1.5+(o.d-1)*0.5)+o.startTime
                if o.d<=12
                    move = 1;
                    ...
                    xshift = hdx * (20 * 1./(240) * o.hFlow.pixPerDeg);
                    % -o.P.speed * 1./(o.P.refreshRate) * obj.pixPerDeg
                    yshift = hdy * (20 * 1./(240) * o.hFlow.pixPerDeg);
                elseif o.d>12
                    xshift =0;
                    yshift =0;
                    move =2;
