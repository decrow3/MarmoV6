classdef superimposed_sine_pair < stimuli.stimulus
...
% worry about the interaction with the playback code
    ...
    methods
        function obj = superimposed_sine_pair(winPtr, varargin)
            % The constructor
            ...
            for gr=1:2
                obj.(['hNoise' num2str(gr)]) = stimuli.grating_drifting_SFlinear(winPtr, ...
                    ...
                    'prefori', ip.Results.prefori, ...
                    'randomizePhase', false); % DO NOT RANDOMISE PHASE
            end


            % Also the controller needs to get some values for timing
            obj.durationOn=ip.Results.durationOn;
            obj.durationOff=ip.Results.durationOff;
...
%            
            ...
            % this is a confounding variable though
