classdef dotspatialImaging < stimuli.stimulus
    %DOTSPATIALNOISE uses the dots class for Expanding-Contracting-Static
    %Dotsflow in Imaging 
    ...
    methods
        function obj = dotspatialImaging(winPtr, varargin)
            ...
            ip.addParameter('size',33.0); % pixels?
            ip.addParameter('speed',7); % deg./s
            ...
            ip.addParameter('pixPerDeg',54.7975)
        ...
        function afterFrame(obj,xshift,yshift,FrameCount)
        
            obj.moveDots(xshift,yshift,FrameCount)
        ...
        function moveDots(obj, xshift, yshift,FrameCount)
            
            obj.dx= xshift;
            %obj.dy = yshift;
            if FrameCount <= 120 || (FrameCount>241 && FrameCount<=360) || ...
                    (FrameCount>481 && FrameCount<=600)|| (FrameCount>721 && FrameCount<=840)...
                    || (FrameCount>961 && FrameCount<=1080)|| (FrameCount>1201 && FrameCount<=1320)
            obj.dy =  - obj.speed *obj.pixPerDeg* 0.0042;
            elseif (FrameCount>120 && FrameCount<=240)|| (FrameCount>361 && FrameCount<=480) ...
                    || (FrameCount>601 && FrameCount<=720)|| (FrameCount>841 && FrameCount<=960) ...
                    || (FrameCount>1081 && FrameCount<=1200)|| (FrameCount>1321 && FrameCount<=1440)
                obj.dy = obj.speed *obj.pixPerDeg* 0.0042;
            elseif FrameCount >1440
                obj.dy = 0;
            end 
